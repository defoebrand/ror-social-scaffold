...
RSpec.feature 'Friendships', type: :feature do
  before(:each) do
    User.create(name: 'user1', email: 'user@user.com', password: 'passwords',
                password_confirmation: 'passwords', id: 1)
    User.create(name: 'friend', email: 'friend@user.com', password: 'passwords',
                password_confirmation: 'passwords', id: 2)
